...
{{< flex gap="1rem" marginY="1rem" flex="initial" >}}

{{< content-box marginY="1rem" content="awfully&nbsp;&nbsp;&nbsp;&nbsp;sorrowfully&nbsp;&nbsp;&nbsp;&nbsp;completely&nbsp;&nbsp;&nbsp;&nbsp;loftily&nbsp;&nbsp;&nbsp;&nbsp;carefully&nbsp;&nbsp;&nbsp;&nbsp;differently&nbsp;&nbsp;&nbsp;&nbsp;quickly&nbsp;&nbsp;&nbsp;&nbsp;nonchalantly" ariaLabel="Adverbs box" >}}

{{< /flex >}}

2. **Now use these adverbs to fill in the blanks in the sentences below.**

**(i)** The report must be read {{< underscored-space>}} so that performance can be improved.  

**Ans:** The report must be read **carefully** so that performance can be improved.  

**(ii)** At the interview, Sameer answered our questions {{< underscored-space >}}, shrugging his shoulders.  

**Ans:** At the interview, Sameer answered our questions **nonchalantly**, shrugging his shoulders.  

**(iii)** We all behave {{< underscored-space>}}  when we are tired or hungry.  

**Ans:** We all behave **awfully** when we are tired or hungry.  

**(iv)** The teacher shook her head {{< underscored-space>}} when Ravi lied to her.  

**Ans:** The teacher shook her head **sorrowfully** when Ravi lied to her.  

**(v)** I {{< underscored-space>}} forgot about it.  
**Ans:** I  **quickly** forgot about it.  

**(vi)** When I complimented Revathi on her success, she just smiled {{< underscored-space>}}  and turned away.  

**Ans:** When I complimented Revathi on her success, she just smiled **loftily** and turned away.  

**(vii)** The President of the Company is {{< underscored-space>}} busy and will not be able to meet you.

**Ans:** The President of the Company is **completely** busy and will not be able to meet you.

**(viii)** I finished my work {{< underscored-space>}} so that I could go out to play.
...
{{< flex direction="column" gap="1rem" flex="initial" >}}

{{< flex gap="1.5rem" flex="initial" >}}
<span>(i) angry {{< underscored-space>}}  </span>
<span>(ii) happy {{< underscored-space>}}  </span>
{{< /flex >}}

{{< flex gap="1.5rem" flex="initial" >}}
<span>(iii) merry {{< underscored-space>}}  </span>
<span>(iv) sleepy {{< underscored-space>}}  </span>
{{< /flex>}}

{{< flex gap="1.5rem" flex="initial" >}}
<span>(v) easy {{< underscored-space>}}  </span>
<span>(vii) tidy {{< underscored-space>}}  </span>
{{< /flex>}}
...
{{< flex gap="1.5rem" flex="initial" >}}
<span>(i) angry {{< content-box content="angrily">}}  </span>
<span>(ii) happy {{< content-box content="happily">}} </span>
{{< /flex >}}

{{< flex gap="1.5rem" flex="initial" >}}
<span>(iii) merry {{< content-box content="merrily">}} </span>
<span>(iv) sleepy {{< content-box content="sleepily">}} </span>
{{< /flex>}}

{{< flex gap="1.5rem" flex="initial" >}}
<span>(v) easy {{< content-box content="easily">}}  </span>
<span>(vii) tidy {{< content-box content="tidily">}}</span>
{{< /flex>}}
...
| Future Tense| If/Unless | Present Tense |
|--------|--------|------------|
| There won't be any books left | unless | you preserve them |
...
1. If I don’t go to Anu’s party tonight, {{< underscored-space>}}.  

2. If you don’t telephone the hotel to order food, {{< underscored-space>}}.  

3. Unless you promise to write back, {{< underscored-space>}}.  

4. If she doesn’t play any games, {{< underscored-space>}}.  

5. Unless that little bird flies away quickly, {{< underscored-space>}}.
